...
function addLocation(locationName, race) {
    // Here we would add the location to the game world
    // and associate it with the specified race.
    console.log(`Added ${locationName} inhabited by ${race} characters.`);
}

// Example usage:
addLocation("Forest of Elves", "Elves");
addLocation("Mountain of Dwarves", "Dwarves");
addLocation("Swamp of Trolls", "Trolls");
